...
import (
	...
	"github.com/sdvaanyaa/url-shortener/internal/http-server/handlers/url/save"
	"github.com/sdvaanyaa/url-shortener/internal/lib/api"
	"github.com/sdvaanyaa/url-shortener/internal/lib/random"
)
...
func TestURLShortener_SaveRedirectRemove(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			reqDel := e.DELETE("/"+alias).WithBasicAuth(
				"user",
				"password",
